...
#     -o run2/${SAMPLE}_R1_trimmed.fastq.gz -p run2/${SAMPLE}_R2_trimmed.fastq.gz \
#     ${SAMPLE}_R1.fastq.gz ${SAMPLE}_R2.fastq.gz \
#     >> run2/cutadapt_primer_trimming_stats.txt 2>&1
# done
# 
# ```
##Load libraries 
...
setwd("/home/mlopez/amplicons/run2")
...
##Filter and trimming
out <- filterAndTrim(fns_R1, filt_R1, fns_R2, filt_R2, truncLen = c(216, 245), 
...
saveRDS(sample.names, "sample.names.2.rds")
saveRDS(out,"out.2.rds")
saveRDS(dada_R1, "dada.R1.2.rds")
saveRDS(dada_R2,"dada.R2.2.rds")
saveRDS(mergers,"mergers.2.rds")
saveRDS(seqtab,"seqtab.2.rds")
